    ...
    <>
      ...
      <style>{`
        ...
        @media (max-width: 900px) {
          ...
          .dy-stats-grid > div { border-right: 1px solid #E4E8E5 !important; border-bottom: 1px solid #E4E8E5; }
        ...
        .dy-fact-row { display: grid; grid-template-columns: 140px 1fr; gap: 12px; padding: 12px 16px; background: #F6F8F6; border: 1px solid #E4E8E5; border-radius: 8px; }
      ...
      <div style={{ backgroundColor: "#FFFFFF", minHeight: "100vh" }}>
        ...
        <div style={{ borderBottom: "1px solid #E4E8E5", backgroundColor: "#F2F8F4" }} className="breadcrumb-pad">
          <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }} className="px-page">
            ...
            <span style={{ fontSize: 11, color: "#3F4B43", fontFamily: "var(--font-jetbrains), monospace", letterSpacing: "0.08em" }}>Dymatize</span>
          </div>
        </div>
        ...
        <div style={{ width: "100%", minHeight: 260, background: "linear-gradient(135deg, #0E1318 0%, #1A2230 45%, #111820 100%)", position: "relative", overflow: "hidden", display: "flex", alignItems: "flex-end" }}>
          ...
          <div style={{ position: "relative", maxWidth: 1280, margin: "0 auto", width: "100%", padding: "40px 24px 36px", zIndex: 1 }} className="px-page">
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14, flexWrap: "wrap" }}>
              <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.22em", color: "rgba(180,200,220,0.35)", textTransform: "uppercase" }}>BRD-004</span>
              ...
              <span style={{ padding: "3px 10px", backgroundColor: "rgba(212,169,106,0.2)", border: "1px solid rgba(212,169,106,0.4)", borderRadius: 4, fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.12em", color: "rgba(212,169,106,0.9)", textTransform: "uppercase", fontWeight: 700 }}>Gold Tier</span>
              <span style={{ padding: "3px 10px", backgroundColor: "rgba(26,107,58,0.15)", border: "1px solid rgba(26,107,58,0.3)", borderRadius: 4, fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.12em", color: "rgba(100,200,130,0.85)", textTransform: "uppercase" }}>Dual Certified</span>
            </div>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
              {["Hydrolyzed Whey", "Whey Isolate", "Casein", "Creatine", "Pre-Workout", "BCAAs"].map((cat) => (
                <span key={cat} style={{ padding: "4px 10px", border: "1px solid rgba(180,200,220,0.12)", borderRadius: 6, fontSize: 10, color: "rgba(242,235,217,0.4)", fontFamily: "var(--font-jetbrains), monospace", letterSpacing: "0.07em" }}>{cat}</span>
              ))}
            </div>
          </div>
        </div>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }} className="pad-section-sm px-page">
          ...
          {/* Mobile TOC */}
          <details className="dy-mobile-toc" style={{ marginBottom: 8, border: "1px solid #E4E8E5", borderRadius: 10, overflow: "hidden", backgroundColor: "#F6F8F6" }}>
          ...
          {/* ── § 01 Brand Overview ────────────────────────────────────────── */}
          <section id="overview" className="dy-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
            ...
            <div className="dy-overview-grid">
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                <div style={{ position: "relative", width: "100%", aspectRatio: "16 / 9", background: "linear-gradient(135deg, #0E1318 0%, #1A2230 100%)", borderRadius: 10, overflow: "hidden", border: "1px solid #E4E8E5" }}>
                  <Image
          ...
          {/* ── § 02 Quick Verdict ─────────────────────────────────────────── */}
          <section id="verdict" className="dy-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
          ...
          {/* ── § 03 Certifications ────────────────────────────────────────── */}
          <section id="certs" className="dy-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
            ...
            <div style={{ padding: "16px 20px", backgroundColor: "rgba(26,107,58,0.06)", border: "1px solid rgba(26,107,58,0.2)", borderRadius: 8, display: "flex", gap: 12, alignItems: "flex-start" }}>
              <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.18em", color: "#1A6B3A", textTransform: "uppercase", paddingTop: 2, flexShrink: 0 }}>Why dual matters</span>
          ...
          {/* ── § 04 Product Lineup ────────────────────────────────────────── */}
          <section id="products" className="dy-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
                ...
                <div key={product.slug} style={{ border: "1px solid #E4E8E5", borderRadius: 10, overflow: "hidden", backgroundColor: "#F6F8F6", display: "flex", flexDirection: "column" }}>
                  {product.image ? (
                    ...
                    <div className="dy-product-img-placeholder">
                      ...
                      <span style={{ position: "absolute", top: 8, right: 10, padding: "2px 8px", backgroundColor: "rgba(180,200,220,0.07)", border: "1px solid rgba(180,200,220,0.12)", borderRadius: 4, fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.08em", color: "rgba(180,200,220,0.4)" }}>{product.category}</span>
                      <span style={{ position: "absolute", bottom: 7, left: 12, fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(180,200,220,0.2)" }}>Image coming</span>
                    </div>
                  )}
          ...
          <section id="reviews" className="dy-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
            ...
            <p style={{ marginTop: 20, fontSize: 13, color: "#6B7770", fontFamily: "var(--font-jetbrains), monospace", letterSpacing: "0.04em" }}>
              Elite Casein and Pre W.O. reviews publishing next.
            </p>
          </section>

          {/* ── § 06 FAQ ───────────────────────────────────────────────────── */}
          <section id="faq" className="dy-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, maxWidth: 820 }}>
              {faqs.map((faq, i) => (
                <details key={i} className="dy-faq-item" style={{ border: "1px solid #E4E8E5", borderRadius: 10, overflow: "hidden", backgroundColor: "#F6F8F6" }}>
          ...
          <section id="stance" className="dy-section-anchor" style={{ marginBottom: 56 }}>
            <div className="dy-stance-card" style={{ backgroundColor: "#0E1318", borderRadius: 12, maxWidth: 840, border: "1px solid rgba(180,200,220,0.08)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16, flexWrap: "wrap" }}>
                <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.22em", textTransform: "uppercase", color: "#2A3540" }}>Editorial Stance</span>
                <span style={{ width: 16, height: 1, backgroundColor: "#1A2530", display: "inline-block" }} />
                <span style={{ padding: "2px 8px", backgroundColor: "rgba(212,169,106,0.15)", border: "1px solid rgba(212,169,106,0.3)", borderRadius: 4, fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.1em", color: "rgba(212,169,106,0.8)", textTransform: "uppercase", fontWeight: 700 }}>Gold Tier · BRD-004</span>
              </div>
