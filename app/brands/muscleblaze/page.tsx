    ...
    <>
      ...
      <style>{`
        ...
        @media (max-width: 900px) {
          ...
          .mb-stats-grid > div { border-right: 1px solid #E4E8E5 !important; border-bottom: 1px solid #E4E8E5; }
        ...
        .mb-fact-row { display: grid; grid-template-columns: 140px 1fr; gap: 12px; padding: 12px 16px; background: #F6F8F6; border: 1px solid #E4E8E5; border-radius: 8px; }
      ...
      <div style={{ backgroundColor: "#FFFFFF", minHeight: "100vh" }}>
        ...
        <div style={{ borderBottom: "1px solid #E4E8E5", backgroundColor: "#F2F8F4" }} className="breadcrumb-pad">
          <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }} className="px-page">
            ...
            <span style={{ fontSize: 11, color: "#3F4B43", fontFamily: "var(--font-jetbrains), monospace", letterSpacing: "0.08em" }}>MuscleBlaze</span>
          </div>
        </div>
        ...
        <div style={{ width: "100%", minHeight: 260, background: "linear-gradient(135deg, #1A0505 0%, #3D0C0C 45%, #220808 100%)", position: "relative", overflow: "hidden", display: "flex", alignItems: "flex-end" }}>
          ...
          <span style={{ position: "absolute", right: -10, bottom: -30, fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "clamp(6rem, 20vw, 16rem)", fontWeight: 800, color: "rgba(255,80,0,0.03)", lineHeight: 1, userSelect: "none", pointerEvents: "none", letterSpacing: "-0.05em" }}>MB</span>
          ...
          <div style={{ position: "relative", maxWidth: 1280, margin: "0 auto", width: "100%", padding: "40px 24px 36px", zIndex: 1 }} className="px-page">
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14, flexWrap: "wrap" }}>
              <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.22em", color: "rgba(255,120,50,0.4)", textTransform: "uppercase" }}>BRD-003</span>
              ...
              <span style={{ padding: "3px 10px", backgroundColor: "rgba(255,120,50,0.12)", border: "1px solid rgba(255,120,50,0.25)", borderRadius: 4, fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.12em", color: "rgba(255,160,80,0.8)", textTransform: "uppercase" }}>USA #1</span>
            </div>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
              {["Whey Protein", "Creatine", "Mass Gainers", "Pre-Workout", "Glutamine", "Multivitamins", "Protein Bars"].map((cat) => (
                <span key={cat} style={{ padding: "4px 10px", border: "1px solid rgba(255,120,50,0.15)", borderRadius: 6, fontSize: 10, color: "rgba(242,235,217,0.4)", fontFamily: "var(--font-jetbrains), monospace", letterSpacing: "0.07em" }}>{cat}</span>
              ))}
            </div>
          </div>
        </div>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }} className="pad-section-sm px-page">
          ...
          <details className="mb-mobile-toc" style={{ marginBottom: 8, border: "1px solid #E4E8E5", borderRadius: 10, overflow: "hidden", backgroundColor: "#F6F8F6" }}>
          ...
          {/* ── § 01 Brand Overview ────────────────────────────────────────── */}
          <section id="overview" className="mb-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
            ...
            <div className="mb-overview-grid">
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                <div style={{ position: "relative", width: "100%", aspectRatio: "16 / 9", background: "linear-gradient(135deg, #1A0505 0%, #3D0C0C 100%)", borderRadius: 10, overflow: "hidden", border: "1px solid #E4E8E5", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <Image
          ...
          {/* ── § 02 Quick Verdict ─────────────────────────────────────────── */}
          <section id="verdict" className="mb-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
          ...
          {/* ── § 03 Certifications ────────────────────────────────────────── */}
          <section id="certs" className="mb-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
            ...
            <div style={{ padding: "16px 20px", backgroundColor: "rgba(155,32,32,0.05)", border: "1px solid rgba(155,32,32,0.15)", borderRadius: 8, display: "flex", gap: 12, alignItems: "flex-start" }}>
              <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.18em", color: "#9B2020", textTransform: "uppercase", paddingTop: 2, flexShrink: 0 }}>Important</span>
          ...
          {/* ── § 04 Product Lineup ────────────────────────────────────────── */}
          <section id="products" className="mb-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
                ...
                <div key={product.slug} style={{ border: "1px solid #E4E8E5", borderRadius: 10, overflow: "hidden", backgroundColor: "#F6F8F6", display: "flex", flexDirection: "column" }}>
                  {product.image ? (
                    ...
                    <div className="mb-product-img-placeholder">
                      <span style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "2.8rem", fontWeight: 800, color: "rgba(255,80,0,0.05)", letterSpacing: "-0.05em" }}>{product.name[0]}</span>
                      <span style={{ position: "absolute", top: 8, right: 10, padding: "2px 8px", backgroundColor: "rgba(255,80,0,0.08)", border: "1px solid rgba(255,80,0,0.15)", borderRadius: 4, fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.08em", color: "rgba(255,160,80,0.5)" }}>{product.category}</span>
                      <span style={{ position: "absolute", bottom: 7, left: 12, fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(255,80,0,0.25)" }}>Image coming</span>
                    </div>
                  )}
          ...
          <section id="reviews" className="mb-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
          ...
          {/* ── § 06 FAQ ───────────────────────────────────────────────────── */}
          <section id="faq" className="mb-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, maxWidth: 820 }}>
              {faqs.map((faq, i) => (
                <details key={i} className="mb-faq-item" style={{ border: "1px solid #E4E8E5", borderRadius: 10, overflow: "hidden", backgroundColor: "#F6F8F6" }}>
          ...
          <section id="stance" className="mb-section-anchor" style={{ marginBottom: 56 }}>
            <div className="mb-stance-card" style={{ backgroundColor: "#1A0505", borderRadius: 12, maxWidth: 840, border: "1px solid rgba(255,80,0,0.08)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16, flexWrap: "wrap" }}>
                <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.22em", textTransform: "uppercase", color: "#3A1A10" }}>Editorial Stance</span>
                <span style={{ width: 16, height: 1, backgroundColor: "#2A0A0A", display: "inline-block" }} />
                <span style={{ padding: "2px 8px", backgroundColor: "rgba(212,201,184,0.1)", border: "1px solid rgba(212,201,184,0.2)", borderRadius: 4, fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.1em", color: "rgba(212,201,184,0.5)", textTransform: "uppercase" }}>Silver Tier · BRD-003</span>
              </div>
