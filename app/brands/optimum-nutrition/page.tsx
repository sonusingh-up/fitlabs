    ...
    <>
      ...
      <style>{`
        ...
        @media (max-width: 900px) {
          ...
          .on-stats-grid > div { border-right: 1px solid #E4E8E5 !important; border-bottom: 1px solid #E4E8E5; }
        ...
        .on-fact-row { display: grid; grid-template-columns: 140px 1fr; gap: 12px; padding: 12px 16px; background: #F6F8F6; border: 1px solid #E4E8E5; border-radius: 8px; }
      ...
      <div style={{ backgroundColor: "#FFFFFF", minHeight: "100vh" }}>
        ...
        <div style={{ borderBottom: "1px solid #E4E8E5", backgroundColor: "#F2F8F4" }} className="breadcrumb-pad">
          <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }} className="px-page">
            ...
            <span style={{ fontSize: 11, color: "#3F4B43", fontFamily: "var(--font-jetbrains), monospace", letterSpacing: "0.08em" }}>Optimum Nutrition</span>
          </div>
        </div>
        ...
        <div style={{ width: "100%", minHeight: 260, background: "linear-gradient(135deg, #0C1933 0%, #162545 40%, #0A1228 100%)", position: "relative", overflow: "hidden", display: "flex", alignItems: "flex-end" }}>
          ...
          <div style={{ position: "relative", maxWidth: 1280, margin: "0 auto", width: "100%", padding: "40px 24px 36px", zIndex: 1 }} className="px-page">
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14, flexWrap: "wrap" }}>
              <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.22em", color: "rgba(100,160,255,0.4)", textTransform: "uppercase" }}>BRD-001</span>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
              {["Whey Protein", "Casein", "Creatine", "Pre-Workout", "Mass Gainers", "Amino Acids", "Multivitamins"].map((cat) => (
                <span key={cat} style={{ padding: "4px 10px", border: "1px solid rgba(100,160,255,0.15)", borderRadius: 6, fontSize: 10, color: "rgba(242,235,217,0.45)", fontFamily: "var(--font-jetbrains), monospace", letterSpacing: "0.07em" }}>{cat}</span>
              ))}
            </div>
          </div>
        </div>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }} className="pad-section-sm px-page">
          ...
          {/* Mobile TOC */}
          <details className="on-mobile-toc" style={{ marginBottom: 8, border: "1px solid #E4E8E5", borderRadius: 10, overflow: "hidden", backgroundColor: "#F6F8F6" }}>
          ...
          {/* ── § 01 Brand Overview ────────────────────────────────────────── */}
          <section id="overview" className="on-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
            ...
            <div className="on-overview-grid">
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                {/* Product hero image */}
                <div style={{ position: "relative", width: "100%", aspectRatio: "16 / 9", background: "linear-gradient(135deg, #0C1933 0%, #162545 100%)", borderRadius: 10, overflow: "hidden", border: "1px solid #E4E8E5", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <Image
          ...
          {/* ── § 02 Quick Verdict ─────────────────────────────────────────── */}
          <section id="verdict" className="on-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
          ...
          {/* ── § 03 Certifications ────────────────────────────────────────── */}
          <section id="certs" className="on-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
            ...
            <div style={{ padding: "16px 20px", backgroundColor: "rgba(26,107,58,0.06)", border: "1px solid rgba(26,107,58,0.2)", borderRadius: 8, display: "flex", gap: 12, alignItems: "flex-start" }}>
              <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.18em", color: "#1A6B3A", textTransform: "uppercase", paddingTop: 2, flexShrink: 0 }}>Note</span>
          ...
          {/* ── § 04 Product Lineup ────────────────────────────────────────── */}
          <section id="products" className="on-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
                ...
                <div key={product.slug} style={{ border: "1px solid #E4E8E5", borderRadius: 10, overflow: "hidden", backgroundColor: "#F6F8F6", display: "flex", flexDirection: "column" }}>
                  ...
                  {product.image ? (
                    ...
                    <div className="on-product-img-placeholder">
                      ...
                      <span style={{ position: "absolute", top: 8, right: 10, padding: "2px 8px", backgroundColor: "rgba(100,160,255,0.08)", border: "1px solid rgba(100,160,255,0.15)", borderRadius: 4, fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.08em", color: "rgba(100,160,255,0.4)" }}>
                        {product.category}
                      </span>
                      <span style={{ position: "absolute", bottom: 7, left: 12, fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(100,160,255,0.25)" }}>
                        Image coming
                      </span>
                    </div>
                  )}
                  ...
                  <div style={{ padding: "14px 16px 16px", flex: 1, display: "flex", flexDirection: "column", gap: 8 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                      <h3 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.05rem", fontWeight: 700, color: "#17211C", margin: 0, letterSpacing: "-0.02em" }}>
                        {product.name}
                      </h3>
          ...
          <section id="reviews" className="on-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
          ...
          {/* ── § 06 FAQ ───────────────────────────────────────────────────── */}
          <section id="faq" className="on-section-anchor" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, maxWidth: 820 }}>
              {faqs.map((faq, i) => (
                <details key={i} className="on-faq-item" style={{ border: "1px solid #E4E8E5", borderRadius: 10, overflow: "hidden", backgroundColor: "#F6F8F6" }}>
          ...
          <section id="stance" className="on-section-anchor" style={{ marginBottom: 56 }}>
            <div className="on-stance-card" style={{ backgroundColor: "#0C1933", borderRadius: 12, maxWidth: 840, border: "1px solid rgba(100,160,255,0.1)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16, flexWrap: "wrap" }}>
                <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.22em", textTransform: "uppercase", color: "#3C5070" }}>Editorial Stance</span>
                <span style={{ width: 16, height: 1, backgroundColor: "#1A2840", display: "inline-block" }} />
                <span style={{ padding: "2px 8px", backgroundColor: "rgba(212,169,106,0.15)", border: "1px solid rgba(212,169,106,0.3)", borderRadius: 4, fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.1em", color: "rgba(212,169,106,0.8)", textTransform: "uppercase", fontWeight: 700 }}>Gold Tier · BRD-001</span>
              </div>
