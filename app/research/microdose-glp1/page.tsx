    ...
    <div style={{ backgroundColor: "#FFFFFF" }}>
      ...
      <div style={{ borderBottom: "1px solid #E4E8E5", backgroundColor: "#F2F8F4" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", gap: 8, padding: "12px 24px", flexWrap: "wrap" }}>
          ...
          <span style={{ color: "#E4E8E5" }}>/</span>
          <span style={{ fontSize: 12, color: "#3F4B43", fontFamily: "var(--font-jetbrains), monospace" }}>Microdose GLP-1</span>
        </div>
      </div>
      ...
      <div style={{ borderBottom: "1px solid #E4E8E5" }} className="pad-hero">
        <div style={{ maxWidth: 800, margin: "0 auto" }} className="px-page">
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16, flexWrap: "wrap" }}>
            <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.2em", color: "#586259", textTransform: "uppercase" }}>RESEARCH · GLP-1 TELEHEALTH</span>
          ...
          <h1 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "clamp(1.8rem, 4vw, 3rem)", fontWeight: 800, letterSpacing: "-0.025em", color: "#1A1714", lineHeight: 1.1, marginBottom: 16 }}>
            ...
            <em style={{ fontStyle: "italic", fontWeight: 400, color: "#3F4B43" }}>Does It Actually Work?</em>
          </h1>
          <p style={{ fontSize: 15, color: "#3F4B43", lineHeight: 1.75, maxWidth: 660, marginBottom: 24 }}>
      ...
      <div style={{ backgroundColor: "#F0EAF5", borderBottom: "1px solid #C4A8D8" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "14px 24px", display: "flex", gap: 12, alignItems: "flex-start" }}>
          <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, color: "#7B5EA7", letterSpacing: "0.15em", textTransform: "uppercase", flexShrink: 0, paddingTop: 3 }}>Medical Notice</span>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto" }} className="pad-section-sm px-page">
        ...
        <section style={{ marginBottom: 48 }}>
          ...
          <p style={{ fontSize: 15, color: "#3F4B43", lineHeight: 1.75, marginBottom: 0 }}>
        ...
        <section style={{ marginBottom: 48 }}>
          ...
          {[
            ...
            <div key={i} style={{ border: "1px solid #E4E8E5", borderRadius: 8, overflow: "hidden", marginBottom: 12 }}>
              <div style={{ padding: "12px 18px", backgroundColor: "#F6F8F6", borderBottom: "1px solid #E4E8E5", display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 8 }}>
                <p style={{ fontWeight: 700, color: "#1A1714", margin: 0, fontSize: 14 }}>{item.study}</p>
                <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 10, color: "#586259" }}>{item.citation}</span>
              </div>
              <div style={{ padding: "14px 18px" }}>
                <p style={{ fontSize: 14, color: "#2D2926", margin: "0 0 8px", lineHeight: 1.65 }}><strong>Finding:</strong> {item.finding}</p>
                <p style={{ fontSize: 13, color: "#3F4B43", margin: 0, lineHeight: 1.6, borderLeft: "2px solid #0F7A5A", paddingLeft: 12 }}>{item.relevance}</p>
              </div>
            </div>
          ))}
        </section>
        ...
        <section style={{ marginBottom: 48 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 12, marginBottom: 20 }}>
            {[
              ...
              <div key={s.symptom} style={{ backgroundColor: "#F6F8F6", border: "1px solid #E4E8E5", borderRadius: 8, padding: "16px 14px" }}>
                <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, color: "#0F7A5A", letterSpacing: "0.12em", textTransform: "uppercase", margin: "0 0 6px" }}>{s.symptom}</p>
          ...
          <p style={{ fontSize: 13, color: "#6B7770", fontFamily: "var(--font-jetbrains), monospace", lineHeight: 1.6 }}>
        ...
        <section style={{ marginBottom: 48 }}>
          ...
          {[
            ...
            <div key={s.step} style={{ display: "flex", gap: 16, padding: "16px 20px", backgroundColor: "#F6F8F6", border: "1px solid #E4E8E5", borderRadius: 8, marginBottom: 8 }}>
              ...
              <div>
                ...
                <p style={{ fontSize: 13, color: "#3F4B43", margin: 0, lineHeight: 1.65 }}>{s.desc}</p>
              </div>
            </div>
          ))}
        </section>
              ...
              <thead>
                <tr style={{ backgroundColor: "#1A1714" }}>
                  {["Weeks", "Dose (Tirzepatide)", "Phase", "Typical Response"].map((h) => (
                    <th key={h} style={{ padding: "10px 14px", textAlign: "left", fontFamily: "var(--font-jetbrains), monospace", fontSize: 10, letterSpacing: "0.08em", color: "#FFFFFF", fontWeight: 600 }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ backgroundColor: i % 2 === 0 ? "#F6F8F6" : "#FFFFFF" }}>
                    <td style={{ padding: "10px 14px", fontFamily: "var(--font-jetbrains), monospace", color: "#0F7A5A", fontWeight: 600 }}>{row.weeks}</td>
                    <td style={{ padding: "10px 14px", fontWeight: 700, color: "#1A1714" }}>{row.dose}</td>
                    <td style={{ padding: "10px 14px", color: "#3F4B43" }}>{row.phase}</td>
                    <td style={{ padding: "10px 14px", color: "#3F4B43", fontSize: 12 }}>{row.response}</td>
                  </tr>
                ))}
              </tbody>
            </table>
              ...
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ backgroundColor: i % 2 === 0 ? "#F6F8F6" : "#FFFFFF" }}>
                    ...
                    <td style={{ padding: "10px 14px", color: "#3F4B43" }}>{row.standard}</td>
              ...
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 6, flexWrap: "wrap", gap: 8 }}>
                  ...
                  <span style={{
                    ...
                    fontFamily: "var(--font-jetbrains), monospace", letterSpacing: "0.08em"
                  }}>
                    {item.fit === "best" ? "Recommended" : "Use Caution"}
                  </span>
                </div>
                <p style={{ fontSize: 13, color: "#3F4B43", margin: "0 0 6px", lineHeight: 1.6 }}>{item.desc}</p>
        ...
        <section style={{ marginBottom: 48 }}>
          ...
          <div style={{ backgroundColor: "#F6F8F6", border: "1px solid #E4E8E5", borderRadius: 12, padding: "24px 28px", marginBottom: 20 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16, flexWrap: "wrap" }}>
              <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.15em", color: "#586259", textTransform: "uppercase" }}>Provider</span>
              <span style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.3rem", fontWeight: 700, color: "#1A1714" }}>WellMedr</span>
              <span style={{ padding: "2px 8px", backgroundColor: "rgba(196,98,45,0.08)", border: "1px solid rgba(196,98,45,0.2)", borderRadius: 4, fontSize: 9, color: "#0F7A5A", fontFamily: "var(--font-jetbrains), monospace" }}>US Only · Rx Required</span>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 12, marginBottom: 16 }}>
              {[
                ...
                <div key={s.label} style={{ borderLeft: "2px solid #0F7A5A", paddingLeft: 12 }}>
                  <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, color: "#586259", letterSpacing: "0.12em", textTransform: "uppercase", margin: "0 0 4px" }}>{s.label}</p>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              <Link
                ...
                style={{ padding: "10px 20px", backgroundColor: "#0F7A5A", color: "#fff", borderRadius: 6, fontSize: 13, fontWeight: 600, textDecoration: "none", display: "inline-block" }}
              >
              ...
              <a
                ...
                style={{ padding: "10px 20px", border: "1px solid #0F7A5A", color: "#0F7A5A", borderRadius: 6, fontSize: 13, fontWeight: 600, textDecoration: "none", display: "inline-block" }}
              >
          ...
          {/* Affiliate notice */}
          <div style={{ padding: "10px 16px", backgroundColor: "#F2F8F4", border: "1px solid #E4E8E5", borderRadius: 6 }}>
            <p style={{ fontSize: 12, color: "#6B7770", margin: 0 }}>
              <strong>Affiliate disclosure:</strong> The WellMedr link above is an affiliate link. Fitlabreviews may earn a commission if you purchase through it. This does not influence our editorial coverage. <Link href="/editorial-policy" style={{ color: "#0F7A5A" }}>Editorial policy →</Link>
            </p>
          </div>
        </section>
          ...
          <ol style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 10 }}>
            {[
              ...
              <li key={i} style={{ fontSize: 13, color: "#3F4B43", lineHeight: 1.7 }}>
                {ref.text}{" "}
                <a href={ref.url} target="_blank" rel="noopener noreferrer" style={{ color: "#0F7A5A", fontSize: 11, fontFamily: "var(--font-jetbrains), monospace", letterSpacing: "0.04em", whiteSpace: "nowrap" }}>Source ↗</a>
              </li>
            ))}
          </ol>
        </section>
