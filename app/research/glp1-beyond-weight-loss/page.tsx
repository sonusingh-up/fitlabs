    ...
    <div style={{ backgroundColor: "#F2EBD9" }}>
      ...
      <div style={{ borderBottom: "1px solid #D4C9B8", backgroundColor: "#EDE8DF" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "12px 24px", display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          <span style={{ color: "#D4C9B8" }}>/</span>
          <span style={{ fontSize: 12, color: "#5C5650", fontFamily: "var(--font-dm-mono), monospace" }}>GLP-1 Beyond Weight Loss</span>
        </div>
      </div>
      ...
      <div style={{ borderBottom: "1px solid #D4C9B8", padding: "48px 24px 40px" }}>
        <div style={{ maxWidth: 780, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 20, alignItems: "center" }}>
            ...
            <span style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 9, color: "#A89880", letterSpacing: "0.12em" }}>ART-008 · GLP-1 Research · 15 min read</span>
      ...
      <div style={{ borderBottom: "1px solid #D4C9B8", backgroundColor: "#1A1714", padding: "32px 24px" }}>
        <div style={{ maxWidth: 780, margin: "0 auto" }}>
          <p style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 9, letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(242,235,217,0.4)", marginBottom: 20 }}>Key Trial Findings at a Glance</p>
      ...
      <div style={{ maxWidth: 780, margin: "0 auto", padding: "48px 24px" }}>
        ...
        <section style={{ marginBottom: 56 }}>
          ...
          <div style={{ backgroundColor: "#EDE8DF", border: "1px solid #D4C9B8", borderRadius: 10, padding: "18px 22px", marginTop: 8 }}>
            <p style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 9, letterSpacing: "0.15em", textTransform: "uppercase", color: "#8A8480", marginBottom: 8 }}>GLP-1 Receptor Locations</p>
        ...
        <section style={{ marginBottom: 56 }}>
          ...
          <div style={{ border: "1px solid #D4C9B8", borderRadius: 10, overflow: "hidden", marginBottom: 24 }}>
            <div style={{ backgroundColor: "#1A1714", padding: "12px 20px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <span style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 10, color: "#C4622D", letterSpacing: "0.12em", fontWeight: 700 }}>SELECT TRIAL · 2023</span>
              <span style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 9, color: "rgba(242,235,217,0.35)", letterSpacing: "0.1em" }}>NEJM · Phase 3 RCT</span>
            </div>
        ...
        <section style={{ marginBottom: 56 }}>
          ...
          <div style={{ backgroundColor: "#EDE8DF", border: "1px solid #D4C9B8", borderRadius: 10, padding: "20px 24px" }}>
            <p style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 9, letterSpacing: "0.18em", textTransform: "uppercase", color: "#8A8480", marginBottom: 12 }}>What's driving the BP reduction?</p>
        ...
        <section style={{ marginBottom: 56 }}>
          ...
          <div style={{ border: "1px solid #D4C9B8", borderRadius: 10, overflow: "hidden", marginBottom: 24 }}>
            <div style={{ backgroundColor: "#1A1714", padding: "12px 20px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <span style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 10, color: "#C4622D", letterSpacing: "0.12em", fontWeight: 700 }}>FLOW TRIAL · 2024</span>
              <span style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 9, color: "rgba(242,235,217,0.35)", letterSpacing: "0.1em" }}>NEJM · Phase 3 RCT — stopped early</span>
            </div>
            <div style={{ padding: "16px 20px", backgroundColor: "#F8F2E4", display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: 12 }}>
              {[
