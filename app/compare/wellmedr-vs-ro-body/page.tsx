    ...
    <div style={{ backgroundColor: "#FFFFFF" }}>
      ...
      <div style={{ borderBottom: "1px solid #E4E8E5", backgroundColor: "#F2F8F4" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", gap: 8, padding: "12px 24px", flexWrap: "wrap" }}>
          ...
          <Link href="/compare" style={{ fontSize: 12, color: "#6B7770", fontFamily: "var(--font-jetbrains), monospace", textDecoration: "none" }}>Compare</Link>
          <span style={{ color: "#E4E8E5" }}>/</span>
          <span style={{ fontSize: 12, color: "#3F4B43", fontFamily: "var(--font-jetbrains), monospace" }}>WellMedr vs Ro Body</span>
        </div>
      </div>
      ...
      <div style={{ borderBottom: "1px solid #E4E8E5" }} className="pad-hero">
        <div style={{ maxWidth: 900, margin: "0 auto" }} className="px-page">
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16, flexWrap: "wrap" }}>
            <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.2em", color: "#586259", textTransform: "uppercase" }}>COMPARISON · GLP-1 TELEHEALTH</span>
            <span style={{ width: 24, height: 1, backgroundColor: "#E4E8E5", display: "inline-block" }} />
            <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.2em", color: "#0F7A5A", textTransform: "uppercase" }}>Updated May 2026</span>
          </div>
          <h1 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "clamp(1.8rem, 4vw, 3rem)", fontWeight: 800, letterSpacing: "-0.025em", color: "#1A1714", lineHeight: 1.1, marginBottom: 16 }}>
            WellMedr vs Ro Body{" "}
            <em style={{ fontStyle: "italic", fontWeight: 400, color: "#3F4B43" }}>(2026): GLP-1 Telehealth Compared</em>
          </h1>
          <p style={{ fontSize: 15, color: "#3F4B43", lineHeight: 1.75, maxWidth: 700, marginBottom: 24 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16, maxWidth: 600 }}>
            {[
              { provider: "WellMedr", score: "8.0", color: "#0F7A5A", wins: verdictCount.wellmedr },
              { provider: "Ro Body", score: "7.2", color: "#3F4B43", wins: verdictCount.roBody },
            ].map((p) => (
              <div key={p.provider} style={{ backgroundColor: "#F6F8F6", border: `2px solid ${p.color}`, borderRadius: 12, padding: "20px 24px", textAlign: "center" }}>
                <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.15em", textTransform: "uppercase", color: "#6B7770", margin: "0 0 8px" }}>FSP Score</p>
                <p style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "2.2rem", fontWeight: 800, color: p.color, margin: "0 0 4px", lineHeight: 1 }}>{p.score}<span style={{ fontSize: "1rem", color: "#586259", fontWeight: 400 }}>/10</span></p>
                <p style={{ fontWeight: 700, color: "#1A1714", margin: "0 0 8px" }}>{p.provider}</p>
                <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 10, color: "#6B7770", margin: 0 }}>{p.wins} categories won</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div style={{ backgroundColor: "#F2F8F4", borderBottom: "1px solid #E4E8E5" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "12px 24px" }}>
          <p style={{ fontSize: 12, color: "#6B7770", margin: 0 }}>
            ...
            {" · "}
            <Link href="/medical-disclaimer" style={{ color: "#0F7A5A" }}>Medical disclaimer →</Link>
          </p>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }} className="pad-section-sm px-page">
        ...
        {/* Quick verdict */}
        <div style={{ backgroundColor: "#F6F8F6", border: "1px solid #E4E8E5", borderRadius: 12, padding: "24px 28px", marginBottom: 48 }}>
          <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.15em", textTransform: "uppercase", color: "#586259", marginBottom: 12 }}>Our Verdict</p>
        ...
        <section style={{ marginBottom: 48 }}>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13, minWidth: 600 }}>
              <thead>
                <tr style={{ backgroundColor: "#1A1714" }}>
                  <th style={{ padding: "12px 16px", textAlign: "left", fontFamily: "var(--font-jetbrains), monospace", fontSize: 10, letterSpacing: "0.08em", color: "#FFFFFF", fontWeight: 600, width: "25%" }}>Category</th>
                  <th style={{ padding: "12px 16px", textAlign: "left", fontFamily: "var(--font-jetbrains), monospace", fontSize: 10, letterSpacing: "0.08em", color: "#0F7A5A", fontWeight: 600, width: "30%" }}>WellMedr</th>
                  <th style={{ padding: "12px 16px", textAlign: "left", fontFamily: "var(--font-jetbrains), monospace", fontSize: 10, letterSpacing: "0.08em", color: "#E4E8E5", fontWeight: 600, width: "30%" }}>Ro Body</th>
                  <th style={{ padding: "12px 16px", textAlign: "left", fontFamily: "var(--font-jetbrains), monospace", fontSize: 10, letterSpacing: "0.08em", color: "#E4E8E5", fontWeight: 600 }}>Winner</th>
                </tr>
              </thead>
              <tbody>
                {compareData.map((row, i) => (
                  <tr key={row.category} style={{ backgroundColor: i % 2 === 0 ? "#F6F8F6" : "#FFFFFF", borderBottom: "1px solid #F2F8F4" }}>
                    <td style={{ padding: "12px 16px", fontWeight: 700, color: "#1A1714", verticalAlign: "top" }}>{row.category}</td>
                    <td style={{ padding: "12px 16px", color: row.verdict === "wellmedr" ? "#0F7A5A" : "#3F4B43", fontWeight: row.verdict === "wellmedr" ? 600 : 400, verticalAlign: "top" }}>{row.wellmedr}</td>
                    <td style={{ padding: "12px 16px", color: row.verdict === "ro-body" ? "#4A7C59" : "#3F4B43", fontWeight: row.verdict === "ro-body" ? 600 : 400, verticalAlign: "top" }}>{row.roBody}</td>
                    <td style={{ padding: "12px 16px", verticalAlign: "top" }}>
                      {row.verdict === "tie" ? (
                        <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, color: "#6B7770", letterSpacing: "0.08em" }}>TIE</span>
                      ) : (
                        <span style={{
                          padding: "2px 8px",
                          ...
                          borderRadius: 4,
                          fontSize: 9,
                          color: row.verdict === "wellmedr" ? "#0F7A5A" : "#4A7C59",
          ...
          <p style={{ fontSize: 12, color: "#6B7770", fontFamily: "var(--font-jetbrains), monospace", marginTop: 12 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 20, marginBottom: 20 }}>
            {[
              ...
              <div key={p.provider} style={{ border: `1px solid ${p.color}`, borderRadius: 12, overflow: "hidden" }}>
                ...
                {p.plans.map((plan, i) => (
                  <div key={i} style={{ padding: "12px 18px", borderBottom: "1px solid #F2F8F4", backgroundColor: i % 2 === 0 ? "#F6F8F6" : "#FFFFFF" }}>
                    ...
                    <p style={{ fontSize: 12, color: "#6B7770", margin: 0 }}>{plan.notes}</p>
                  </div>
                ))}
              </div>
            ))}
        ...
        <section style={{ marginBottom: 48 }}>
          ...
          <div style={{ backgroundColor: "#F6F8F6", border: "1px solid #E4E8E5", borderRadius: 8, padding: "20px 24px", marginBottom: 16 }}>
            <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.15em", textTransform: "uppercase", color: "#0F7A5A", marginBottom: 12 }}>SURMOUNT-5 Head-to-Head Trial (Jastreboff 2024)</p>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 16 }}>
              {[
                ...
                <div key={row.metric} style={{ borderLeft: "2px solid #0F7A5A", paddingLeft: 12 }}>
                  <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, color: "#586259", letterSpacing: "0.1em", textTransform: "uppercase", margin: "0 0 6px" }}>{row.metric}</p>
                  <p style={{ fontSize: 13, margin: "0 0 2px" }}><strong style={{ color: "#0F7A5A" }}>Tirzepatide: {row.tirzepatide}</strong></p>
                  <p style={{ fontSize: 13, margin: 0, color: "#3F4B43" }}>Semaglutide: {row.sema}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section style={{ marginBottom: 48 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 20 }}>
            <div style={{ backgroundColor: "#F6F8F6", border: "2px solid #0F7A5A", borderRadius: 12, padding: "24px 24px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
                ...
                <span style={{ padding: "2px 8px", backgroundColor: "#0F7A5A", color: "#fff", borderRadius: 4, fontSize: 9, fontFamily: "var(--font-jetbrains), monospace", letterSpacing: "0.1em" }}>OUR TOP PICK</span>
              </div>
              <p style={{ fontSize: 13, color: "#3F4B43", lineHeight: 1.6, marginBottom: 16 }}>Compounded tirzepatide from $88/mo. Microdosing available. Same-day consultations. US residents only.</p>
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                <a
                  href="https://www.wellmedr.com/pages/get-started-weight-loss"
                  target="_blank"
                  rel="nofollow noopener sponsored"
                  style={{ display: "block", padding: "12px 20px", backgroundColor: "#0F7A5A", color: "#fff", borderRadius: 6, fontSize: 13, fontWeight: 700, textDecoration: "none", textAlign: "center" }}
                >
                  Start at WellMedr ↗
                </a>
                <Link href="/reviews/wellmedr" style={{ display: "block", padding: "10px 20px", border: "1px solid #0F7A5A", color: "#0F7A5A", borderRadius: 6, fontSize: 13, fontWeight: 600, textDecoration: "none", textAlign: "center" }}>
                  Read Full Review →
                </Link>
              </div>
            </div>

            <div style={{ backgroundColor: "#F6F8F6", border: "1px solid #E4E8E5", borderRadius: 12, padding: "24px 24px" }}>
              ...
              <p style={{ fontSize: 13, color: "#3F4B43", lineHeight: 1.6, marginBottom: 16 }}>Compounded semaglutide from $99/mo. Branded Wegovy/Ozempic options. Insurance assistance available. US only.</p>
              <p style={{ fontSize: 12, color: "#6B7770", fontStyle: "italic" }}>
        ...
        <section style={{ marginBottom: 48 }}>
          ...
          <ol style={{ paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
            {[
              ...
              <li key={i} style={{ fontSize: 13, color: "#3F4B43", lineHeight: 1.65 }}>{ref}</li>
            ))}
          </ol>
        </section>
