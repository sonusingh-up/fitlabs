    ...
    <div style={{ backgroundColor: "#F2EBD9", minHeight: "100vh" }}>
      ...
      <div style={{ borderBottom: "1px solid #D4C9B8", padding: "64px 24px 52px" }}>
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          ...
          <h1 style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 800, letterSpacing: "-0.025em", color: "#1A1714", lineHeight: 1.05, marginBottom: 20 }}>
            Editorial Policy &amp;{" "}
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "64px 24px 80px" }}>
        ...
        <section id="independence-guarantee" style={{ marginBottom: 72, paddingBottom: 72, borderBottom: "1px solid #D4C9B8" }}>
          ...
          <h2 style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "1.75rem", fontWeight: 700, color: "#1A1714", marginBottom: 24, letterSpacing: "-0.02em" }}>
            Independence Guarantee
          </h2>
        ...
        <section id="scoring-scale" style={{ marginBottom: 72, paddingBottom: 72, borderBottom: "1px solid #D4C9B8" }}>
          ...
          <h2 style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "1.75rem", fontWeight: 700, color: "#1A1714", marginBottom: 8, letterSpacing: "-0.02em" }}>
            Scoring Scale
          </h2>
            ...
            {scoring.map((s, i) => (
              ...
              >
                <div style={{ padding: "20px 16px", borderRight: "1px solid #EDE8DF", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "center", backgroundColor: s.bg }}>
                  <span style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: 22, fontWeight: 800, color: s.color, lineHeight: 1 }}>{s.range}</span>
        ...
        <section id="fsp-system" style={{ marginBottom: 72, paddingBottom: 72, borderBottom: "1px solid #D4C9B8" }}>
          ...
          <h2 style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "1.75rem", fontWeight: 700, color: "#1A1714", marginBottom: 16, letterSpacing: "-0.02em" }}>
            ...
            {fspPillars.map((p) => (
              <div key={p.label} style={{ padding: "20px 20px", border: "1px solid #D4C9B8", borderRadius: 10, backgroundColor: "#F8F2E4" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8, gap: 8 }}>
                  <p style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: 13, fontWeight: 700, color: "#1A1714", margin: 0, lineHeight: 1.3 }}>{p.label}</p>
          ...
          <div style={{ border: "1px solid #D4C9B8", borderRadius: 12, overflow: "hidden" }}>
            {conflicts.map((c, i) => (
              ...
              >
                ...
                <p style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: 15, fontWeight: 700, color: "#1A1714", marginBottom: 10 }}>{c.q}</p>
