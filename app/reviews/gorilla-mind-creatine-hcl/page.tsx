      ...
      <div style={{ backgroundColor: "#F2EBD9", minHeight: "100vh" }}>
        ...
        <div style={{ borderBottom: "1px solid #D4C9B8", backgroundColor: "#EDE8DF" }} className="breadcrumb-pad">
          <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }} className="px-page">
            ...
            <span style={{ fontSize: 11, color: "#5C5650", fontFamily: "var(--font-dm-mono), monospace", letterSpacing: "0.08em" }}>Gorilla Mind Creatine HCl</span>
          </div>
        </div>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "48px 0 40px", gap: 32 }}>
              <div style={{ flex: 1, minWidth: 0 }}>
                <div className="hidden sm:flex" style={{ alignItems: "center", gap: 12, marginBottom: 16 }}>
                  <span style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 9, letterSpacing: "0.25em", textTransform: "uppercase", color: "rgba(242,235,217,0.3)", whiteSpace: "nowrap" }}>REV-2026-057</span>
        ...
        <div style={{ borderBottom: "1px solid #D4C9B8", backgroundColor: "#EDE8DF" }}>
          <div style={{ maxWidth: 1280, margin: "0 auto", padding: "12px 24px", display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
            ...
            <span style={{ color: "#D4C9B8", fontSize: 11 }}>·</span>
            <span style={{ fontSize: 11, color: "#8A8480", fontFamily: "var(--font-dm-mono), monospace", letterSpacing: "0.08em" }}>REV-2026-057</span>
            <span style={{ color: "#D4C9B8", fontSize: 11 }}>·</span>
            <span style={{ fontSize: 11, color: "#8A8480", fontFamily: "var(--font-dm-mono), monospace", letterSpacing: "0.08em" }}>Creatine HCl · CON-CRĒT®</span>
            <span style={{ color: "#D4C9B8", fontSize: 11 }}>·</span>
          ...
          <div className="layout-sidebar">
            ...
            <article style={{ minWidth: 0 }}>
              ...
              <div className="block sm:hidden" style={{ margin: "0 0 48px" }}>
                <div style={{ borderRadius: 14, overflow: "hidden", border: "1px solid #D4C9B8", backgroundColor: "#F8F2E4" }}>
                  ...
                  <div style={{ padding: "16px 20px 20px" }}>
                    ...
                    <p style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "1.15rem", fontWeight: 800, color: "#1A1714", letterSpacing: "-0.02em", lineHeight: 1.15, marginBottom: 12 }}>Creatine HCl</p>
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
                      <div>
                        <p style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 9, letterSpacing: "0.1em", textTransform: "uppercase", color: "#A89880", marginBottom: 2 }}>Price / 100 scoops</p>
                        <p style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "1.1rem", fontWeight: 800, color: "#1A1714" }}>$39.99</p>
                      </div>
                      <a href="https://amzn.to/3PAhINz" target="_blank" rel="nofollow noopener noreferrer"
              ...
              <section id="what-is" style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #EDE8DF" }}>
                <h2 style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "1.4rem", fontWeight: 700, color: "#1A1714", marginBottom: 16, letterSpacing: "-0.02em" }}>What Is Creatine HCl?</h2>
                  ...
                  <table style={{ borderCollapse: "collapse", minWidth: 480, width: "100%" }}>
                    <thead>
                      <tr style={{ backgroundColor: "#1A1714" }}>
                        ...
                        <th style={{ padding: "12px 16px", textAlign: "right", fontFamily: "var(--font-dm-mono), monospace", fontSize: 10, letterSpacing: "0.1em", textTransform: "uppercase", color: "#8A8480", width: "28%" }}>Per Scoop (2.5g)</th>
                        <th style={{ padding: "12px 16px", textAlign: "center", fontFamily: "var(--font-dm-mono), monospace", fontSize: 10, letterSpacing: "0.1em", textTransform: "uppercase", color: "#8A8480", width: "30%" }}>Equiv. Mono Dose</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
              ...
              <section id="ingredients" style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #EDE8DF" }}>
                ...
                <div style={{ padding: "16px 20px", backgroundColor: "#EDE8DF", border: "1px solid #D4C9B8", borderRadius: 10, marginTop: 8 }}>
                  <p style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 9, letterSpacing: "0.14em", textTransform: "uppercase", color: "#A89880", marginBottom: 8 }}>HCl vs Monohydrate — the honest scorecard</p>
                    ...
                    <tbody>
                      {[
                        ...
                        <tr key={row.product} style={{ backgroundColor: i % 2 === 0 ? "#F8F2E4" : "#F2EBD9" }}>
                          ...
                          <td style={{ padding: "10px 14px", fontSize: 12, color: "#5C5650", whiteSpace: "nowrap" }}>{row.gi}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                </div>
                <p style={{ fontSize: 13, color: "#8A8480", marginTop: 12, lineHeight: 1.6 }}>Prices verified May 2026.</p>
              </section>
              ...
              <section id="products" style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #EDE8DF" }}>
                ...
                <p style={{ fontSize: 14, color: "#5C5650", lineHeight: 1.7, marginBottom: 20 }}>For the monohydrate version from the same brand, see our <Link href="/reviews/gorilla-mind-creatine-monohydrate" style={{ color: "#3A5F8B", textDecoration: "none" }}>Gorilla Mind Micronized review</Link>.</p>
              ...
              <section id="where-to-buy" style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #EDE8DF" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: 12, marginBottom: 16 }}>
                  {[
                    { retailer: "Amazon",             url: "https://amzn.to/3PAhINz",      note: "Prime shipping, competitive pricing",  recommended: true  },
                    { retailer: "gorillamind.com",    url: "https://gorillamind.com",        note: "Direct — bundle discounts available",  recommended: false },
                    { retailer: "Vitamin Shoppe",     url: "https://www.vitaminshoppe.com",  note: "Member discounts apply",              recommended: false },
                    { retailer: "Dick&apos;s Sporting", url: "https://www.dickssportinggoods.com", note: "In-store availability",         recommended: false },
                  ].map((r) => (
                ...
                <p style={{ fontSize: 13, color: "#8A8480", lineHeight: 1.6 }}>Prices verified May 2026.</p>
              </section>
                  ...
                  {faqSchema.mainEntity.map((faq, i) => (
                    <details key={i} style={{ backgroundColor: i % 2 === 0 ? "#F8F2E4" : "#F2EBD9", borderRadius: 8, border: "1px solid #EDE8DF", overflow: "hidden" }}>
                      <summary style={{ padding: "15px 18px", cursor: "pointer", listStyle: "none", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, userSelect: "none" }}>
                        ...
                        <span className="faq-icon-gmhcl" style={{ width: 24, height: 24, borderRadius: "50%", backgroundColor: "#EDE8DF", border: "1px solid #D4C9B8", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, color: "#3A5F8B" }}>
                ...
                <div style={{ padding: "28px 32px", backgroundColor: "#1A1714", borderRadius: 12 }}>
                  <div style={{ display: "flex", alignItems: "flex-start", gap: 24, flexWrap: "wrap" }}>
                    <div style={{ flex: 1, minWidth: 240 }}>
                      <p style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 9, letterSpacing: "0.2em", textTransform: "uppercase", color: "#5C5650", marginBottom: 12 }}>FSP · 7/10 · Gorilla Mind Creatine HCl</p>
                    ...
                    <div style={{ textAlign: "center", flexShrink: 0 }}>
                      ...
                      <p style={{ fontSize: 10, color: "#5C5650", fontFamily: "var(--font-dm-mono), monospace", marginTop: 8 }}>$39.99 · 100 scoops</p>
                    </div>
                  </div>
                </div>
              </section>
