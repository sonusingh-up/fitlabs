            ...
            <article style={{ minWidth: 0 }}>
              ...
              <section id="where-to-buy" style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #EDE8DF" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: 12, marginBottom: 16 }}>
                  {[
                    { retailer: "Amazon",          url: "https://amzn.to/3PAiUk1",      note: "Prime shipping, frequently discounted",  recommended: true  },
                    { retailer: "gorillamind.com", url: "https://gorillamind.com",        note: "Direct — bundle pricing available",       recommended: false },
                    { retailer: "Walmart",         url: "https://www.walmart.com",       note: "Often slightly cheaper than Amazon",      recommended: false },
                    { retailer: "Dick&apos;s Sporting", url: "https://www.dickssportinggoods.com", note: "In-store and online",            recommended: false },
                  ].map((r) => (
                ...
                <p style={{ fontSize: 13, color: "#8A8480", lineHeight: 1.6 }}>Prices verified May 2026. Walmart occasionally lists below Amazon — worth checking both before ordering.</p>
              </section>
