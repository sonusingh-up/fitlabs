                  ...
                  <table style={{ borderCollapse: "collapse", minWidth: 480, width: "100%" }}>
                    ...
                    <tbody>
                      {[
                        ...
                        { name: "CherryPURE® (Montmorency Tart Cherry, 50:1)", amount: "500 mg", clinical: "480–500 mg ✓" },
                        { name: "L-Tryptophan", amount: "200 mg", clinical: "150–300 mg ✓" },
                        ...
                        <tr key={row.name} style={{ backgroundColor: i % 2 === 0 ? "#F8F2E4" : "#F2EBD9", borderBottom: "1px solid #EDE8DF" }}>
                          ...
                          <td style={{ padding: "11px 16px", textAlign: "center" }}>
                            <span style={{ display: "inline-block", padding: "2px 9px", backgroundColor: row.clinical.includes("✓") ? "rgba(45,106,79,0.10)" : "rgba(139,115,85,0.10)", border: `1px solid ${row.clinical.includes("✓") ? "rgba(45,106,79,0.25)" : "rgba(139,115,85,0.25)"}`, borderRadius: 20, fontSize: 11, color: row.clinical.includes("✓") ? "#2D6A4F" : "#8B7355", fontFamily: "var(--font-dm-mono), monospace", whiteSpace: "nowrap", fontWeight: 600 }}>
                              {row.clinical}
                            </span>
                          </td>
                        </tr>
