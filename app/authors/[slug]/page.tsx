  ...
  return (
    <div style={{ backgroundColor: "#F2EBD9" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: 28, flexWrap: "wrap" }}>
            ...
            <div style={{ flexShrink: 0 }}>
              <div style={{ width: 96, height: 96, borderRadius: "50%", backgroundColor: author.accent, display: "flex", alignItems: "center", justifyContent: "center", border: "4px solid #D4C9B8" }}>
                <span style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "2rem", fontWeight: 800, color: "#F2EBD9" }}>{author.initials}</span>
              </div>
            </div>

            {/* Name + meta */}
            <div style={{ flex: 1, minWidth: 240 }}>
              <h1 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "clamp(1.8rem, 4vw, 2.8rem)", fontWeight: 800, letterSpacing: "-0.025em", color: "#1A1714", lineHeight: 1.05, marginBottom: 6 }}>
                {author.name}
              </h1>
              ...
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                ...
                <Link href="/editorial-policy" style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "8px 16px", border: "1px solid #D4C9B8", color: "#5C5650", fontSize: 13, borderRadius: 8, fontFamily: "var(--font-hanken), sans-serif", textDecoration: "none", backgroundColor: "#F8F2E4" }}>
                  Editorial Policy
                </Link>
              </div>
            </div>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }} className="pad-section-sm px-page">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: 12 }}>
            {[
              ...
              <div key={stat.label} style={{ padding: "20px", border: "1px solid #D4C9B8", borderRadius: 8, backgroundColor: "#F8F2E4" }}>
                ...
                <p style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.5rem", fontWeight: 700, color: "#1A1714", margin: 0 }}>{stat.value}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* Bio */}
        <section style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #D4C9B8" }}>
          <h2 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.4rem", fontWeight: 700, color: "#1A1714", marginBottom: 16, letterSpacing: "-0.02em" }}>About</h2>
        ...
        {/* Credentials */}
        <section style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #D4C9B8" }}>
          <h2 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.4rem", fontWeight: 700, color: "#1A1714", marginBottom: 16, letterSpacing: "-0.02em" }}>Credentials & Methodology</h2>
        ...
        {reviews.length > 0 && (
          <section style={{ marginBottom: 48 }}>
            ...
            <Link href="/category" style={{ fontSize: 13, color: "#C4622D", fontWeight: 600, fontFamily: "var(--font-hanken), sans-serif", textDecoration: "none" }}>
              View all reviews →
            </Link>
          </section>
        )}
