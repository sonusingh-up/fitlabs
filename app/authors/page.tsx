...
export const authors = [
  ...
  },
  {
    ...
    figure: "AUT-02",
    bio: "Pankaj founded Fitlabreviews to fill a gap in the Indian supplement market — honest, formula-first reviews that aren't influenced by affiliate money or brand relationships. He oversees the editorial direction, scoring methodology, and all final review verdicts. With a focus on the Indian and global supplement market, Pankaj brings an ingredient-first lens to every category.",
    specialties: ["Supplement Strategy", "Indian Market Analysis", "Editorial Direction", "Brand Benchmarking"],
    reviewCount: 24,
    ingredientProfiles: 8,
    since: "2025",
    credentials: ["Founder, Fitlabreviews", "Evidence-Based Nutrition Research", "Indian Supplement Market Specialist"],
    ...
    <div style={{ backgroundColor: "#F2EBD9" }}>
      ...
      <div style={{ borderBottom: "1px solid #D4C9B8", backgroundColor: "#EDE8DF" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "12px 24px", display: "flex", gap: 8 }}>
          ...
          <span style={{ fontSize: 12, color: "#5C5650", fontFamily: "var(--font-dm-mono), monospace" }}>Authors</span>
        </div>
      </div>
      ...
      <div style={{ borderBottom: "1px solid #D4C9B8", padding: "60px 24px 48px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
            <span style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 9, letterSpacing: "0.2em", color: "#A89880", textTransform: "uppercase" }}>RESEARCH TEAM · {authors.length} AUTHORS</span>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }} className="pad-section-sm px-page">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            {authors.map((author) => (
              <Link
                ...
                className="hub-card"
                style={{ display: "grid", gridTemplateColumns: "auto 1fr", gap: 0, border: "1px solid #D4C9B8", borderRadius: 12, overflow: "hidden", textDecoration: "none", backgroundColor: "#F8F2E4" }}
              >
                {/* Accent sidebar */}
                ...
                <div style={{ padding: "28px 32px", display: "grid", gridTemplateColumns: "88px 1fr", gap: 28, alignItems: "start" }}>
                  ...
                  <div>
                    <div style={{ marginBottom: 12 }}>
                      ...
                      <p style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", color: "#8A8480", margin: 0 }}>{author.role}</p>
                    </div>

                    <p style={{ fontSize: 14, color: "#5C5650", lineHeight: 1.75, marginBottom: 16 }}>{author.bio}</p>
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                      {author.specialties.map((s) => (
                        <span key={s} style={{ padding: "3px 9px", border: "1px solid #D4C9B8", borderRadius: 4, fontSize: 10, color: "#5C5650", fontFamily: "var(--font-dm-mono), monospace", letterSpacing: "0.07em", backgroundColor: "#EDE8DF" }}>{s}</span>
                      ))}
                    </div>
        ...
        {/* Trust note */}
        <div style={{ marginTop: 56, padding: "24px 28px", backgroundColor: "#EDE8DF", border: "1px solid #D4C9B8", borderRadius: 12, borderLeft: "3px solid #C4622D" }}>
          <p style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 9, letterSpacing: "0.18em", textTransform: "uppercase", color: "#8A8480", marginBottom: 8 }}>Editorial Transparency</p>
          <p style={{ fontSize: 14, color: "#5C5650", lineHeight: 1.75, margin: 0 }}>
            ...
            <Link href="/contact" style={{ color: "#C4622D", fontWeight: 600 }}>contact us directly</Link>.
          </p>
        </div>
