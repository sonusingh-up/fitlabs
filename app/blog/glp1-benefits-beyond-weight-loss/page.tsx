    ...
    <div style={{ backgroundColor: "#FFFFFF" }}>
      <div style={{ borderBottom: "1px solid #E4E8E5", backgroundColor: "#F2F8F4" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "12px 24px", display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          <span style={{ color: "#E4E8E5" }}>/</span>
          <span style={{ fontSize: 12, color: "#3F4B43", fontFamily: "var(--font-jetbrains), monospace" }}>GLP-1 Benefits Beyond Weight Loss</span>
        </div>
      </div>
      ...
      <div style={{ borderBottom: "1px solid #E4E8E5" }} className="pad-hero">
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16, flexWrap: "wrap" }}>
            <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.2em", color: "#586259", textTransform: "uppercase" }}>BLG-002</span>
            <span style={{ width: 24, height: 1, backgroundColor: "#E4E8E5", display: "inline-block" }} />
            <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.2em", color: "#0F7A5A", textTransform: "uppercase" }}>Metabolic Health · GLP-1 Science</span>
          </div>
          <h1 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "clamp(1.9rem, 5vw, 3.2rem)", fontWeight: 800, letterSpacing: "-0.025em", color: "#1A1714", lineHeight: 1.08, marginBottom: 20 }}>
            ...
            <em style={{ fontStyle: "italic", fontWeight: 400, color: "#3F4B43" }}>5 Surprising Benefits Beyond Weight Loss</em>
          </h1>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 16, alignItems: "center", marginBottom: 24 }}>
            ...
            <span style={{ color: "#E4E8E5" }}>·</span>
            <span style={{ fontSize: 12, color: "#6B7770", fontFamily: "var(--font-jetbrains), monospace" }}>13 min read</span>
            <span style={{ color: "#E4E8E5" }}>·</span>
            <span style={{ padding: "2px 8px", borderRadius: 4, fontSize: 9, fontFamily: "var(--font-jetbrains), monospace", letterSpacing: "0.1em", fontWeight: 700, color: "#1A6B3A", backgroundColor: "rgba(26,107,58,0.08)", border: "1px solid rgba(26,107,58,0.2)", textTransform: "uppercase" }}>Strong Evidence</span>
          </div>
          <div style={{ display: "flex", gap: 1, flexWrap: "wrap" }}>
            {[
              ...
              <div key={i} style={{ padding: "14px 20px", backgroundColor: i === 0 ? "#1A1714" : "#F0E8D5", border: "1px solid #E4E8E5", flex: 1, minWidth: 150 }}>
                <p style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.5rem", fontWeight: 800, color: i === 0 ? "#0F7A5A" : "#1A1714", margin: 0 }}>{s.value}</p>
                <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.12em", color: i === 0 ? "#6B7770" : "#586259", textTransform: "uppercase", marginTop: 4 }}>{s.label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }} className="container-pad">
        <div className="layout-sidebar">
          ...
          <article style={{ maxWidth: 680, minWidth: 0 }}>
            ...
            <section id="what-glp1-does" style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #F2F8F4" }}>
              ...
              <div style={{ padding: "16px 18px", backgroundColor: "#F2F8F4", border: "1px solid #E4E8E5", borderLeft: "3px solid #0F7A5A", borderRadius: 8 }}>
                <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.15em", textTransform: "uppercase", color: "#586259", marginBottom: 6 }}>Drugs covered in this article</p>
            ...
            <section id="cardiovascular" style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #F2F8F4" }}>
              <h2 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.5rem", fontWeight: 700, color: "#1A1714", marginBottom: 16, letterSpacing: "-0.02em" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 20 }}>
                {[
                  ...
                  <div key={r.study} style={{ padding: "16px 18px", border: "1px solid #E4E8E5", borderRadius: 8, backgroundColor: "#F6F8F6" }}>
                    <div style={{ display: "flex", gap: 10, alignItems: "flex-start", marginBottom: 6, flexWrap: "wrap" }}>
                      <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 11, fontWeight: 700, color: "#1A1714" }}>{r.study}</span>
                      <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 10, color: "#586259" }}>— {r.journal}</span>
                    </div>
                    <p style={{ fontSize: 13, color: "#3F4B43", lineHeight: 1.7, margin: 0 }}>{r.finding}</p>
                  </div>
                ))}
              </div>
            ...
            <section id="kidney" style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #F2F8F4" }}>
              <h2 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.5rem", fontWeight: 700, color: "#1A1714", marginBottom: 16, letterSpacing: "-0.02em" }}>
              ...
              <div style={{ padding: "20px 22px", border: "1px solid #E4E8E5", borderRadius: 8, backgroundColor: "#F6F8F6", marginBottom: 20 }}>
                <div style={{ display: "flex", gap: 10, alignItems: "flex-start", marginBottom: 8, flexWrap: "wrap" }}>
                  <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 11, fontWeight: 700, color: "#1A1714" }}>FLOW trial (Perkovic et al., 2024)</span>
                  <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 10, color: "#586259" }}>— NEJM — 3,533 participants with T2D + CKD</span>
                </div>
                <p style={{ fontSize: 13, color: "#3F4B43", lineHeight: 1.7, margin: 0 }}>
            ...
            <section id="addiction" style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #F2F8F4" }}>
              <h2 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.5rem", fontWeight: 700, color: "#1A1714", marginBottom: 16, letterSpacing: "-0.02em" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 20 }}>
                {[
                  ...
                  <div key={item.claim} style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 16, padding: "12px 16px", border: "1px solid #E4E8E5", borderRadius: 8, backgroundColor: "#F6F8F6", flexWrap: "wrap" }}>
                    <p style={{ fontSize: 13, color: "#2D2926", flex: 1 }}>{item.claim}</p>
                    <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.08em", color: "#92620A", backgroundColor: "rgba(146,98,10,0.08)", border: "1px solid rgba(146,98,10,0.2)", padding: "2px 8px", borderRadius: 4, flexShrink: 0 }}>{item.status}</span>
                  </div>
                ))}
              </div>
              <p style={{ fontSize: 14, color: "#3F4B43", lineHeight: 1.75 }}>
            ...
            <section id="neuroprotection" style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #F2F8F4" }}>
              <h2 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.5rem", fontWeight: 700, color: "#1A1714", marginBottom: 16, letterSpacing: "-0.02em" }}>
                4. Neuroprotection
              </h2>
              <p style={{ fontSize: 15, color: "#2D2926", lineHeight: 1.8, marginBottom: 20 }}>
              ...
              <div style={{ padding: "16px 18px", border: "1px solid #E4E8E5", borderRadius: 8, backgroundColor: "#F6F8F6", marginBottom: 16 }}>
                <div style={{ display: "flex", gap: 10, marginBottom: 8, flexWrap: "wrap" }}>
                  <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 11, fontWeight: 700, color: "#1A1714" }}>Athauda et al. (2017)</span>
                  <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 10, color: "#586259" }}>— The Lancet — Parkinson&apos;s disease RCT</span>
                </div>
                <p style={{ fontSize: 13, color: "#3F4B43", lineHeight: 1.7, margin: 0 }}>
            ...
            <section id="inflammation" style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #F2F8F4" }}>
              <h2 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.5rem", fontWeight: 700, color: "#1A1714", marginBottom: 16, letterSpacing: "-0.02em" }}>
              ...
              <div style={{ padding: "18px 20px", backgroundColor: "#F2F8F4", border: "1px solid #E4E8E5", borderLeft: "3px solid #0F7A5A", borderRadius: 8 }}>
                <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.15em", textTransform: "uppercase", color: "#586259", marginBottom: 6 }}>Why this matters beyond labs</p>
                <p style={{ fontSize: 13, color: "#3F4B43", lineHeight: 1.7, margin: 0 }}>
            ...
            <section id="who-for" style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #F2F8F4" }}>
              <h2 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.5rem", fontWeight: 700, color: "#1A1714", marginBottom: 16, letterSpacing: "-0.02em" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 16 }}>
                <div style={{ padding: "16px 18px", backgroundColor: "#F2F8F4", border: "1px solid #E4E8E5", borderRadius: 8 }}>
                  <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.15em", textTransform: "uppercase", color: "#1A6B3A", marginBottom: 8 }}>Strongest evidence for</p>
                  {["T2D with high CV risk", "Obesity (BMI ≥30) with metabolic comorbidities", "CKD with T2D", "Established ASCVD without diabetes (SELECT data)"].map(i => <p key={i} style={{ fontSize: 12, color: "#3F4B43", lineHeight: 1.6, margin: "0 0 5px", paddingLeft: 8, borderLeft: "2px solid #1A6B3A" }}>{i}</p>)}
                </div>
                <div style={{ padding: "16px 18px", backgroundColor: "#F2F8F4", border: "1px solid #E4E8E5", borderRadius: 8 }}>
                  <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.15em", textTransform: "uppercase", color: "#8A4020", marginBottom: 8 }}>Contraindicated / caution</p>
                  {["Personal/family history of MTC or MEN2", "Active pancreatitis", "Pregnancy", "Lean individuals without metabolic disease"].map(i => <p key={i} style={{ fontSize: 12, color: "#3F4B43", lineHeight: 1.6, margin: "0 0 5px", paddingLeft: 8, borderLeft: "2px solid #0F7A5A" }}>{i}</p>)}
                </div>
              </div>
              <p style={{ fontSize: 14, color: "#3F4B43", lineHeight: 1.75 }}>
            ...
            <section id="bottom-line" style={{ marginBottom: 48 }}>
              <div style={{ padding: "28px 30px", backgroundColor: "#1A1714", borderRadius: 12 }}>
                ...
                <h3 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.25rem", fontWeight: 700, color: "#FFFFFF", marginBottom: 14, lineHeight: 1.3 }}>
                  GLP-1 agonists are systemic metabolic drugs, not weight loss pills.
                </h3>
                <p style={{ fontSize: 14, color: "#6B7770", lineHeight: 1.8, marginBottom: 12 }}>
                ...
                <p style={{ fontSize: 14, color: "#6B7770", lineHeight: 1.8 }}>
              ...
              <div style={{ marginTop: 32, padding: "20px 22px", border: "1px solid #E4E8E5", borderRadius: 8, backgroundColor: "#F6F8F6" }}>
                <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.18em", textTransform: "uppercase", color: "#586259", marginBottom: 12 }}>Key References</p>
                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                  ...
                  ].map(r => <p key={r} style={{ fontSize: 11, color: "#6B7770", lineHeight: 1.6, fontFamily: "var(--font-jetbrains), monospace", margin: 0 }}>{r}</p>)}
                </div>
              </div>
            </section>
          </article>
        ...
        {/* Related Content */}
        <section style={{ marginTop: 72, paddingTop: 48, borderTop: "2px solid #E4E8E5" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 32 }}>
            ...
            <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.2em", color: "#0F7A5A", textTransform: "uppercase" }}>GLP-1 · Metabolic Health · Obesity</span>
          </div>
          <div style={{ marginBottom: 40 }}>
            <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.18em", textTransform: "uppercase", color: "#6B7770", marginBottom: 14 }}>Research Articles</p>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 12 }}>
              {[
                { href: "/research/microdose-glp1", label: "GLP-1 Science", title: "Microdosing GLP-1", sub: "Clinical evidence review", teaser: "Emerging data on sub-therapeutic GLP-1 dosing for metabolic maintenance without full drug-level side effects.", accent: "#0F7A5A", evidence: "Limited", ec: "#8A4020" },
                ...
                <Link key={item.href} href={item.href} className="hub-card" style={{ display: "grid", gridTemplateColumns: "3px 1fr", textDecoration: "none", border: "1px solid #E4E8E5", borderRadius: 10, overflow: "hidden", backgroundColor: "#F6F8F6" }}>
                  <div style={{ backgroundColor: item.accent }} />
                  <div style={{ padding: "14px 16px", display: "flex", flexDirection: "column", gap: 6 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 8, letterSpacing: "0.12em", textTransform: "uppercase", color: "#586259" }}>{item.label}</span>
                      <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 8, color: item.ec, padding: "1px 6px", backgroundColor: `${item.ec}12`, border: `1px solid ${item.ec}25`, borderRadius: 3 }}>{item.evidence}</span>
                    </div>
                    <div><p style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "0.95rem", fontWeight: 700, color: "#1A1714", margin: 0, lineHeight: 1.2 }}>{item.title}</p><p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, color: "#6B7770", marginTop: 2 }}>{item.sub}</p></div>
                    <p style={{ fontSize: 12, color: "#3F4B43", lineHeight: 1.6, margin: 0 }}>{item.teaser}</p>
                    <span style={{ fontSize: 11, color: "#0F7A5A", fontWeight: 600, fontFamily: "var(--font-hanken), sans-serif" }}>Read Article →</span>
                  </div>
                </Link>
              ))}
            </div>
          ...
          <div style={{ marginBottom: 40 }}>
            <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.18em", textTransform: "uppercase", color: "#6B7770", marginBottom: 14 }}>Related Ingredients</p>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: 12 }}>
              {[
                { href: "/ingredients/tirzepatide", label: "GLP-1/GIP Agonist", title: "Tirzepatide", sub: "Mounjaro · Zepbound", teaser: "Dual GIP/GLP-1 mechanism — superior weight loss vs semaglutide in SURMOUNT trials.", accent: "#0F7A5A" },
                ...
                <Link key={item.href} href={item.href} className="hub-card" style={{ display: "grid", gridTemplateColumns: "3px 1fr", textDecoration: "none", border: "1px solid #E4E8E5", borderRadius: 10, overflow: "hidden", backgroundColor: "#F6F8F6" }}>
                  ...
                  <div style={{ padding: "14px 16px", display: "flex", flexDirection: "column", gap: 6 }}>
                    <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 8, letterSpacing: "0.12em", textTransform: "uppercase", color: "#586259" }}>{item.label}</span>
                    <div><p style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "0.95rem", fontWeight: 700, color: "#1A1714", margin: 0 }}>{item.title}</p><p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, color: "#6B7770", marginTop: 2 }}>{item.sub}</p></div>
                    <p style={{ fontSize: 12, color: "#3F4B43", lineHeight: 1.6, margin: 0 }}>{item.teaser}</p>
                    <span style={{ fontSize: 11, color: "#0F7A5A", fontWeight: 600, fontFamily: "var(--font-hanken), sans-serif" }}>View Profile →</span>
                  </div>
                </Link>
              ))}
            </div>
          ...
          <div style={{ marginBottom: 40 }}>
            <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.18em", textTransform: "uppercase", color: "#6B7770", marginBottom: 14 }}>Product Reviews</p>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 12 }}>
              {[
                ...
                { href: "/reviews/optimum-nutrition-gold-standard-whey", label: "Protein Powder", title: "ON Gold Standard Whey", brand: "Optimum Nutrition", verdict: "High-quality protein essential for countering lean mass loss during GLP-1 therapy.", rating: 9, accent: "#0F7A5A" },
              ].map(item => (
                <Link key={item.href} href={item.href} className="hub-card" style={{ display: "grid", gridTemplateColumns: "3px 1fr", textDecoration: "none", border: "1px solid #E4E8E5", borderRadius: 10, overflow: "hidden", backgroundColor: "#F6F8F6" }}>
                  <div style={{ backgroundColor: item.accent }} />
                  <div style={{ padding: "14px 16px", display: "flex", flexDirection: "column", gap: 6 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 8, letterSpacing: "0.12em", textTransform: "uppercase", color: "#586259" }}>{item.label}</span>
                      <div style={{ display: "flex", alignItems: "baseline", gap: 1 }}><span style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.1rem", fontWeight: 800, color: item.rating >= 9 ? "#1A6B3A" : "#0F7A5A", lineHeight: 1 }}>{item.rating}</span><span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, color: "#586259" }}>/10</span></div>
                    </div>
                    <div><p style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "0.95rem", fontWeight: 700, color: "#1A1714", margin: 0, lineHeight: 1.2 }}>{item.title}</p><p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, color: "#6B7770", marginTop: 2 }}>{item.brand}</p></div>
                    <p style={{ fontSize: 12, color: "#3F4B43", lineHeight: 1.6, margin: 0 }}>{item.verdict}</p>
                    <span style={{ fontSize: 11, color: "#0F7A5A", fontWeight: 600, fontFamily: "var(--font-hanken), sans-serif" }}>Read Review →</span>
                  </div>
                </Link>
              ))}
            </div>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12, padding: "20px 24px", backgroundColor: "#F2F8F4", border: "1px solid #E4E8E5", borderRadius: 10 }}>
            <div>
              <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.18em", textTransform: "uppercase", color: "#586259", marginBottom: 4 }}>More from Blog</p>
            ...
            <Link href="/blog" style={{ padding: "10px 20px", backgroundColor: "#1A1714", color: "#FFFFFF", borderRadius: 8, fontSize: 12, fontWeight: 600, fontFamily: "var(--font-hanken), sans-serif", textDecoration: "none", flexShrink: 0 }}>Browse All Articles →</Link>
          </div>
          <div style={{ marginTop: 24, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
            <Link href="/blog" style={{ fontSize: 13, color: "#6B7770", fontFamily: "var(--font-hanken), sans-serif", textDecoration: "none" }}>← Back to Blog</Link>
            <div style={{ display: "flex", gap: 8 }}>
              {["GLP-1", "Ozempic", "Metabolic Health", "Cardiology"].map(t => <span key={t} style={{ padding: "3px 9px", border: "1px solid #E4E8E5", borderRadius: 4, fontSize: 10, color: "#3F4B43", fontFamily: "var(--font-jetbrains), monospace" }}>{t}</span>)}
            </div>
          </div>
        </section>
      </div>
