    ...
    <div style={{ backgroundColor: "#FFFFFF" }}>
      <div style={{ borderBottom: "1px solid #E4E8E5", backgroundColor: "#F2F8F4" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "12px 24px", display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          <span style={{ color: "#E4E8E5" }}>/</span>
          <span style={{ fontSize: 12, color: "#3F4B43", fontFamily: "var(--font-jetbrains), monospace" }}>Plant Foods for Menopause</span>
        </div>
      </div>
      ...
      <div style={{ borderBottom: "1px solid #E4E8E5" }} className="pad-hero">
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16, flexWrap: "wrap" }}>
            <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.2em", color: "#586259", textTransform: "uppercase" }}>BLG-003</span>
            <span style={{ width: 24, height: 1, backgroundColor: "#E4E8E5", display: "inline-block" }} />
            <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.2em", color: "#0F7A5A", textTransform: "uppercase" }}>Women&apos;s Health · Nutrition</span>
          </div>
          <h1 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "clamp(1.9rem, 5vw, 3.2rem)", fontWeight: 800, letterSpacing: "-0.025em", color: "#1A1714", lineHeight: 1.08, marginBottom: 20 }}>
            ...
            <em style={{ fontStyle: "italic", fontWeight: 400, color: "#3F4B43" }}>7 Foods That Combat Weight Gain Naturally</em>
          </h1>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 16, alignItems: "center", marginBottom: 24 }}>
            ...
            <span style={{ color: "#E4E8E5" }}>·</span>
            <span style={{ padding: "2px 8px", borderRadius: 4, fontSize: 9, fontFamily: "var(--font-jetbrains), monospace", letterSpacing: "0.1em", fontWeight: 700, color: "#92620A", backgroundColor: "rgba(146,98,10,0.08)", border: "1px solid rgba(146,98,10,0.2)", textTransform: "uppercase" }}>Moderate Evidence</span>
          </div>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }} className="container-pad">
        <div className="layout-sidebar">
          ...
          <article style={{ maxWidth: 680, minWidth: 0 }}>
            ...
            <section id="why-menopause-changes-fat" style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #F2F8F4" }}>
              ...
              <div style={{ padding: "16px 18px", backgroundColor: "#F2F8F4", border: "1px solid #E4E8E5", borderLeft: "3px solid #0F7A5A", borderRadius: 8 }}>
                <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.15em", textTransform: "uppercase", color: "#586259", marginBottom: 6 }}>What food can and cannot do</p>
            ...
            <section id="phytoestrogens" style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #F2F8F4" }}>
            ...
            {[
              ...
              <section key={section.id} id={section.id} style={{ marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #F2F8F4" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 10, color: "#6B7770", margin: 0, letterSpacing: "0.08em" }}>{section.sub}</p>
                  </div>
                </div>
                {section.body.map((p, i) => (
                  p.isBlock
                    ? <div key={i} style={{ padding: "16px 18px", border: "1px solid #E4E8E5", borderRadius: 8, backgroundColor: "#F6F8F6", marginBottom: 16 }}><p style={{ fontSize: 14, color: "#3F4B43", lineHeight: 1.75, margin: 0 }}>{p.text}</p></div>
                    : <p key={i} style={{ fontSize: 15, color: "#2D2926", lineHeight: 1.8, marginBottom: 16 }}>{p.text}</p>
                ))}
                {section.callout && (
                  <div style={{ padding: "16px 18px", backgroundColor: "#F2F8F4", border: "1px solid #E4E8E5", borderLeft: "3px solid #0F7A5A", borderRadius: 8 }}>
                    <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.15em", textTransform: "uppercase", color: "#586259", marginBottom: 6 }}>{section.callout.label}</p>
                    <p style={{ fontSize: 13, color: "#3F4B43", lineHeight: 1.7, margin: 0 }}>{section.callout.text}</p>
                  </div>
                )}
              </section>
            ))}
        ...
        <section style={{ marginTop: 72, paddingTop: 48, borderTop: "2px solid #E4E8E5" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 32 }}>
            ...
            <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.2em", color: "#0F7A5A", textTransform: "uppercase" }}>Menopause · Hormones · Nutrition</span>
          </div>
          <div style={{ marginBottom: 40 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 12 }}>
              {[
                ...
                { href: "/research/protein-timing-myth", label: "Nutrition Science", title: "The Protein Timing Myth", sub: "vs. reality", teaser: "Total daily protein (1.6–2.2g/kg) matters most for muscle preservation during menopause — timing is secondary.", accent: "#0F7A5A", evidence: "Strong", ec: "#1A6B3A" },
                ...
                <Link key={item.href} href={item.href} className="hub-card" style={{ display: "grid", gridTemplateColumns: "3px 1fr", textDecoration: "none", border: "1px solid #E4E8E5", borderRadius: 10, overflow: "hidden", backgroundColor: "#F6F8F6" }}>
                  ...
                  <div style={{ padding: "14px 16px", display: "flex", flexDirection: "column", gap: 6 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 8, letterSpacing: "0.12em", textTransform: "uppercase", color: "#586259" }}>{item.label}</span><span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 8, color: item.ec, padding: "1px 6px", backgroundColor: `${item.ec}12`, border: `1px solid ${item.ec}25`, borderRadius: 3 }}>{item.evidence}</span></div>
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: 12 }}>
              {[
                ...
                { href: "/ingredients/whey-protein", label: "Protein", title: "Whey Protein", sub: "Muscle preservation", teaser: "Maintaining 1.6–2.2g/kg protein intake is the single most important dietary factor for lean mass during menopause.", accent: "#0F7A5A" },
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 12 }}>
              {[
                { href: "/reviews/optimum-nutrition-gold-standard-whey", label: "Protein Powder", title: "ON Gold Standard Whey", brand: "Optimum Nutrition", verdict: "Clean-label whey to hit protein targets for lean mass preservation during and after menopause.", rating: 9, accent: "#0F7A5A" },
                ...
                <Link key={item.href} href={item.href} className="hub-card" style={{ display: "grid", gridTemplateColumns: "3px 1fr", textDecoration: "none", border: "1px solid #E4E8E5", borderRadius: 10, overflow: "hidden", backgroundColor: "#F6F8F6" }}>
                  <div style={{ backgroundColor: item.accent }} />
                  <div style={{ padding: "14px 16px", display: "flex", flexDirection: "column", gap: 6 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 8, letterSpacing: "0.12em", textTransform: "uppercase", color: "#586259" }}>{item.label}</span><div style={{ display: "flex", alignItems: "baseline", gap: 1 }}><span style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.1rem", fontWeight: 800, color: item.rating >= 9 ? "#1A6B3A" : "#0F7A5A", lineHeight: 1 }}>{item.rating}</span><span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, color: "#586259" }}>/10</span></div></div>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12, padding: "20px 24px", backgroundColor: "#F2F8F4", border: "1px solid #E4E8E5", borderRadius: 10 }}>
            <div><p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.18em", textTransform: "uppercase", color: "#586259", marginBottom: 4 }}>More from Blog</p><p style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1rem", fontWeight: 700, color: "#1A1714", margin: 0 }}>Practical fitness &amp; nutrition guides — no fluff, no sponsorship.</p></div>
          ...
          <div style={{ marginTop: 24, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>{["Menopause", "Phytoestrogens", "Nutrition", "Women's Health"].map(t => <span key={t} style={{ padding: "3px 9px", border: "1px solid #E4E8E5", borderRadius: 4, fontSize: 10, color: "#3F4B43", fontFamily: "var(--font-jetbrains), monospace" }}>{t}</span>)}</div>
          </div>
        </section>
      </div>
    </div>
