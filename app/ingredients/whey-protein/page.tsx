      ...
      <div style={{ backgroundColor: "#FFFFFF" }}>
        ...
        <div style={{ borderBottom: "1px solid #E4E8E5", backgroundColor: "#F2F8F4" }}>
          <div style={{ maxWidth: 900, margin: "0 auto", padding: "12px 24px", display: "flex", gap: 8, flexWrap: "wrap" }}>
            ...
            <span style={{ color: "#E4E8E5" }}>/</span>
            <span style={{ fontSize: 12, color: "#3F4B43", fontFamily: "var(--font-jetbrains), monospace" }}>Whey Protein Isolate</span>
          </div>
        </div>
        ...
        <div style={{ borderBottom: "1px solid #E4E8E5" }} className="pad-hero">
          <div style={{ maxWidth: 900, margin: "0 auto" }} className="px-page">
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16, flexWrap: "wrap" }}>
              <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.2em", color: "#586259", textTransform: "uppercase" }}>ING-002</span>
            ...
            <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 11, letterSpacing: "0.12em", color: "#6B7770", marginBottom: 8, textTransform: "uppercase" }}>Muscle Protein Synthesis · Recovery</p>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }} className="pad-section-sm px-page">
          ...
          <section style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }} className="ingredient-article">
            ...
            <div style={{ border: "1px solid #E4E8E5", borderRadius: 12, overflow: "hidden", marginBottom: 24, marginTop: 8 }}>
              <div style={{ padding: "12px 20px", backgroundColor: "#17211C", borderBottom: "1px solid #2D2926" }}>
                <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.2em", textTransform: "uppercase", color: "#586259", margin: 0 }}>The Leucine → mTORC1 → MPS Pathway — Step by Step</p>
              </div>
              {[
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 24 }} className="layout-compare-simple">
              <div style={{ border: "2px solid #0F7A5A", borderRadius: 12, overflow: "hidden" }}>
                <div style={{ padding: "12px 18px", backgroundColor: "#0F7A5A" }}>
                  <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(242,235,217,0.7)", margin: 0 }}>Primary Target</p>
                  <p style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1rem", fontWeight: 700, color: "#FFFFFF", margin: 0 }}>Total Daily Protein</p>
                </div>
                <div style={{ padding: "16px 18px", backgroundColor: "#F6F8F6" }}>
                  <p style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.6rem", fontWeight: 800, color: "#17211C", marginBottom: 4 }}>1.6–2.2g <span style={{ fontSize: "0.9rem", color: "#6B7770", fontWeight: 400 }}>/ kg / day</span></p>
                  <p style={{ fontSize: 13, color: "#3F4B43", lineHeight: 1.65, marginBottom: 12 }}>The research-supported range for athletes in resistance training (Morton et al., 2018). Spread across 3–4 meals for maximal MPS stimulation throughout the day.</p>
              ...
              <div style={{ border: "1px solid #E4E8E5", borderRadius: 12, overflow: "hidden" }}>
                <div style={{ padding: "12px 18px", backgroundColor: "#F2F8F4", borderBottom: "1px solid #E4E8E5" }}>
                  <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.18em", textTransform: "uppercase", color: "#6B7770", margin: 0 }}>Per Serving</p>
                  <p style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1rem", fontWeight: 700, color: "#17211C", margin: 0 }}>Individual Dose</p>
                </div>
                <div style={{ padding: "16px 18px", backgroundColor: "#FFFFFF" }}>
                  <p style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.6rem", fontWeight: 800, color: "#17211C", marginBottom: 4 }}>20–40g <span style={{ fontSize: "0.9rem", color: "#6B7770", fontWeight: 400 }}>/ serving</span></p>
                  <p style={{ fontSize: 13, color: "#3F4B43", lineHeight: 1.65, marginBottom: 12 }}>For a 75kg athlete, 0.25–0.40g/kg = <strong>19–30g protein</strong> per meal to maximise MPS. 40g is the ceiling for acute MPS stimulation — larger doses are oxidised rather than used for muscle building.</p>
                  <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
          ...
          {/* 5. Supplement Forms */}
          <section style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
            <h2 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.5rem", fontWeight: 700, color: "#17211C", marginBottom: 8, letterSpacing: "-0.02em" }}>Whey Protein Forms Compared</h2>
          ...
          <section style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }}>
            <h2 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "1.5rem", fontWeight: 700, color: "#17211C", marginBottom: 8, letterSpacing: "-0.02em" }}>Who Should — and Shouldn't — Take Whey Protein</h2>
            <p style={{ fontSize: 14, color: "#6B7770", marginBottom: 20, lineHeight: 1.6 }}>
            ...
            <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.18em", textTransform: "uppercase", color: "#2D6A4F", marginBottom: 10 }}>Likely to benefit significantly</p>
            ...
            <p style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.18em", textTransform: "uppercase", color: "#8B7355", marginBottom: 10 }}>Limited benefit or proceed with caution</p>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {[
                {
          ...
          <section style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #E4E8E5" }} className="ingredient-article">
            ...
            <div style={{ border: "1px solid #E4E8E5", borderRadius: 10, overflow: "hidden", marginBottom: 24 }}>
              ...
              <div style={{ padding: "10px 14px", backgroundColor: "#F2F8F4", borderTop: "1px solid #E4E8E5" }}>
                <p style={{ fontSize: 11, color: "#6B7770", margin: 0 }}>Prices from major US retailers (Amazon, official brand stores), May 2026. Fair value for WPI: $0.60–$0.90 per 25g protein serving. Hydrolysed commands a premium with marginal real-world advantage.</p>
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 24 }}>
              {[
                ...
                <div key={b.name} style={{ padding: "14px 18px", border: "1px solid #E4E8E5", borderRadius: 8, backgroundColor: "#F6F8F6" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 10, marginBottom: 6, flexWrap: "wrap" }}>
                    <p style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: 14, fontWeight: 700, color: "#17211C", margin: 0 }}>{b.name}</p>
                    <span style={{ padding: "2px 8px", backgroundColor: `${b.badgeColor}12`, border: `1px solid ${b.badgeColor}30`, borderRadius: 4, fontSize: 9, color: b.badgeColor, fontFamily: "var(--font-jetbrains), monospace", letterSpacing: "0.1em", textTransform: "uppercase" as const, whiteSpace: "nowrap" as const }}>{b.badge}</span>
                  </div>
                  <p style={{ fontSize: 13, color: "#3F4B43", lineHeight: 1.65, margin: 0 }}>{b.detail}</p>
                </div>
              ))}
            </div>
