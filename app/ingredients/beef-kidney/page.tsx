    ...
    <div style={{ backgroundColor: "#FFFFFF" }}>
      ...
      <div style={{ borderBottom: "1px solid #E4E8E5", backgroundColor: "#F2F8F4" }} className="breadcrumb-pad">
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ color: "#E4E8E5" }}>/</span>
          <span style={{ fontSize: 12, color: "#3F4B43", fontFamily: "var(--font-jetbrains), monospace" }}>Beef Kidney</span>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }} className="pad-section px-page">
        <div style={{ marginBottom: 48 }}>
          <div className="hidden sm:flex" style={{ alignItems: "center", gap: 12, marginBottom: 16 }}>
            <span style={{ fontFamily: "var(--font-jetbrains), monospace", fontSize: 9, letterSpacing: "0.2em", textTransform: "uppercase", color: "#586259", whiteSpace: "nowrap" }}>ING-2026-013</span>
          ...
          <h1 style={{ fontFamily: "var(--font-newsreader), Georgia, serif", fontSize: "clamp(1.8rem, 4vw, 2.8rem)", fontWeight: 800, letterSpacing: "-0.025em", color: "#17211C", lineHeight: 1.05, marginBottom: 16 }}>
            ...
            <em style={{ display: "block", fontWeight: 400, fontStyle: "italic", color: "#3F4B43", fontSize: "0.7em", marginTop: 8 }}>Selenium, Riboflavin & Detox Support</em>
          </h1>
          <p style={{ fontSize: 15, color: "#3F4B43", lineHeight: 1.75, marginBottom: 12 }}>Beef kidney is the most selenium-dense major organ meat, providing 140–160µg per 100g — roughly 2.5x the selenium density of liver. It is also rich in riboflavin (B2) and CoQ10. In multi-organ supplement blends, kidney adds selenium and B2 to the nutritional profile without increasing the retinol load of liver.</p>
