...
export default function MuscleBlazeMobileTOC() {
  const [open, setOpen] = useState(false);

  return (
    <nav
      aria-label="Page sections"
      style={{ margin: "0 0 8px", border: "1px solid #D4C9B8", borderRadius: 10, overflow: "hidden", backgroundColor: "#F8F2E4" }}
    >
      <button
        onClick={() => setOpen((o) => !o)}
        aria-expanded={open}
        style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "13px 16px", background: "none", border: "none", cursor: "pointer", borderBottom: open ? "1px solid #D4C9B8" : "none" }}
      >
